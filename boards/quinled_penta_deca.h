#pragma once
// QuinLED AN-Penta Deca — 15 analog PWM outputs, no Ethernet
// https://quinled.info/quinled-an-penta-deca-pinout-guide/

#define BOARD_NAME  "QuinLED AN-Penta Deca"
#define HW_VERSION  "v1"

// No RAVLIGHT_HAS_ETHERNET — GPIO 17,18,23 used as LED outputs, not ETH

// LED outputs (15 total):
...
// Timer groups sharing frequency: LS {0,4},{1,5},{2,6},{3,7}; HS {8,12},{9,13},{10,14}
...
// all 15 outputs default to LED_PWM 1kHz
